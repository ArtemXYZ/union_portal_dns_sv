"""
Django settings for portal_dns project.
...
SECRET_KEY = 'django-insecure-8(98cf=*$d459#8$c^8!!f)p08jq$*g1ye86pq6j-f^n#pk&=8'
...
WSGI_APPLICATION = 'portal_dns.wsgi.application'
